  ...
  <body data-col="1-column" class=" 1-column  blank-page blank-page">
	...
	include "connect.php";
		...
		if(isset($_POST['submit']))
		{
			  $email=$_POST['email'];
			  $pass=md5($_POST['pass']);
			  $sql="SELECT * FROM users WHERE userEmail='$email' AND password='$pass'";
            ...
            <div class="col-12 d-flex align-items-center justify-content-center gradient-aqua-marine">
                <div class="card px-4 py-2 box-shadow-2 width-400">
                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-lg" name="pass" id="inputPass" placeholder="Password" required>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer grey darken-1">
                        ...
                        <div class="text-center">Don't have an account? <a href="signup.php"><b>Signup</b></a></div>
                    </div>
                </div>
            </div>
        </div>
